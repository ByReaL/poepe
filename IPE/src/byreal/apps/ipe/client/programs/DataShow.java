...
public class DataShow extends Window {
	...
	public DataShow(final SimpleEventBus IPEEventBus) {
		...
		final VerticalLayoutContainer dataShowVContainer = new VerticalLayoutContainer();

		dataShowVContainer.add(getStashToolBar,  new VerticalLayoutData(1, -1, new Margins(0, 0, 0, 0)));
		//dataShowVContainer.add(poeStashGrid,  new VerticalLayoutData(1, 1, new Margins(0, 0, 0, 0)));
