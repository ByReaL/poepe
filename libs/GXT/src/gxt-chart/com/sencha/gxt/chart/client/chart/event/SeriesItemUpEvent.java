...
/**
 * Fired when the mouse is released over the {@link Series}.
 */
public class SeriesItemUpEvent<M> extends GwtEvent<SeriesItemUpHandler<M>> {
  ...
  public interface HasSeriesItemUpHandlers<M> {
    ...
    /**
     * Adds a {@link SeriesItemUpHandler} handler for {@link SeriesItemUpEvent}
     * events.
     * 
     * @param handler the handler
     * @return the registration for the event
     */
    HandlerRegistration addSeriesItemUpHandler(SeriesItemUpHandler<M> handler);
  }

  /**
   * Handler class for {@link SeriesItemUpEvent} events.
   */
   ...
   * Handler type.
   */
  private static Type<SeriesItemUpHandler<?>> TYPE;
   ...
   */
  public static Type<SeriesItemUpHandler<?>> getType() {
    if (TYPE == null) {
      TYPE = new Type<SeriesItemUpHandler<?>>();
    }
    return TYPE;
  }
   ...
   */
  public SeriesItemUpEvent(M item, ValueProvider<? super M, ? extends Number> valueProvider, int index, Event event) {
    this.item = item;
  ...
  @Override
  public Type<SeriesItemUpHandler<M>> getAssociatedType() {
    return (Type) getType();
  }
  ...
  @Override
  protected void dispatch(SeriesItemUpHandler<M> handler) {
    handler.onSeriesItemUp(this);
  }
